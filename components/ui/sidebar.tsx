    ...
    >
      ...
      >
        <div
          data-sidebar="sidebar"
          className={cn(
            "bg-sidebar flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow",
          )}
        >
          {children}
        </div>
...
function SidebarMenuSubButton({
  ...
  className,
  ...props
}: React.ComponentProps<"a"> & { asChild?: boolean; size?: "sm" | "default"; isActive?: boolean }) {
